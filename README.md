...
- **Dependencies:** Supported frameworks will be included in the installation package.

## 🛠️ Features
- **Visual Dashboard:** Access a comprehensive dashboard to manage your proxies.
- **Live Logs:** Monitor real-time logs to see your data as it flows.
- **Integrated Inspector:** Analyze and debug your proxies seamlessly.
- **Support for Multiple Protocols:** Handle stdio, SSE, streamable HTTP, and OpenAPI.
...
- **Dashboard:** Upon launching, you will see the dashboard. It displays all active proxies and their statuses.
- **Managing Proxies:** You can create new proxies by clicking the "New Proxy" button.
- **Logs:** Access live logs through the log panel. It updates automatically as data is received.

## 📊 Monitoring Your Proxies
You can track the performance of your proxies in real time. Use filters to find specific logs or issues quickly. The integrated inspector allows you to analyze data in detail.

## 🧑‍🤝‍🧑 Support and Feedback
If you encounter any issues or have questions:
- Check the **Issues** section of our GitHub repo for known problems.
- Join our community discussions and find help from other users.
- Feel free to create a new issue for support.

## 🌐 Contributing
We welcome contributions to improve **mcp-proxy-studio**. To contribute:
- Fork the repository.
